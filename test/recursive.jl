...
@testitem "basic" begin
    ...
    @test modify(x->x+10, m, or) === (a=11, bs=CartesianIndex(12, 13))
    @test setall(m, or, (10, 20, 30)) === (a=10, bs=CartesianIndex(20, 30))
...
@testitem "unrecurcize" begin
    ...
    @test tree_concatoptic(Nothing, RecursiveOfType(Number)) === concat()
